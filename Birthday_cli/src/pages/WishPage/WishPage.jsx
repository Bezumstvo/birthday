...
const mapDispatchToProps = dispatch => ({
  getById: (dataproduct) => dispatch(wishesActions.getById(dataproduct)),
})

const connectedWishPage = connect(mapStateToProps,mapDispatchToProps)(WishPage);
export { connectedWishPage as WishPage };
